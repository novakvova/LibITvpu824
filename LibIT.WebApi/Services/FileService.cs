...
namespace LibIT.WebApi.Entities
{
    ...
    {
        public void SaveFile(List<IFormFile> files, string subDirectory, IWebHostEnvironment env)
        {
        ...
        public (string fileType, byte[] archiveData, string archiveName) FetechFiles(string subDirectory)
        {
            ...
            var files = Directory.GetFiles(Path.Combine("C:\\D\\webroot\\", subDirectory)).ToList();
